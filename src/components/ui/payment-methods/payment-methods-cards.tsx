...
function AMEX({ size = DEFAULT_SIZE }: CreditCardProps) {
  return (
    ...
    >
      <rect fill="#fff" fillRule="evenodd" height="80" rx="4" width="80" x="40" />
      <path
...
function GENERIC({ size = DEFAULT_SIZE }: CreditCardProps) {
  return (
    ...
    >
      ...
      <path d="M97.0264 65H83.0264" stroke="white" strokeLinecap="round" strokeWidth="4" />
      <path d="M75.853 65H61.853" stroke="white" strokeLinecap="round" strokeWidth="4" />
      <path d="M54.6797 65H40.6797" stroke="white" strokeLinecap="round" strokeWidth="4" />
      <path d="M33.5063 65H19.5063" stroke="white" strokeLinecap="round" strokeWidth="4" />
      <path
      ...
      <path
        ...
        strokeWidth="1.333"
      />
      <path d="M106.493 15H92.4932" stroke="#EDEDED" strokeLinecap="round" strokeWidth="4" />
      <defs>
        <linearGradient
          gradientUnits="userSpaceOnUse"
...
export const CARD_COMPONENTS = { AMEX, DINERS, GENERIC, JCB, MASTERCARD, VISA } as const
