    ...
    <main className="flex shrink-0 grow flex-col items-center justify-center gap-y-4 p-4">
      <div className="flex flex-col items-center gap-y-4">
        ...
        <p className="text-center text-balance text-fg-muted">
          We’re sorry, but we couldn’t complete your request. Please try again in a few moments, or
          return to the homepage.
        </p>
      </div>

      <Button
        render={<Link className={cx(buttonVariants.subtle, 'mt-4 h-10 gap-x-2')} replace to="/" />}
      >
        <ArrowLeftIcon />
        Return to Home
      </Button>
